...
# version : +0.1
#    Se corrige el método report.getLogger para devolver una instancia de  
#    de Logger nula (sin reporte efectivo), cuando no se ha creado la 
#    instancia de report.
...
class report :
   ...
   def __init__(self, parent_logger, filename = 'report.log') :
      ...
      detallado al archivo filename, el que si no se especifíca
